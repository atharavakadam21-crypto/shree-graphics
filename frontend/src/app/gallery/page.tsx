...
export default function GalleryPage(){return <main className="min-h-screen overflow-x-hidden bg-[#0B1220] text-white"><Header/><GalleryHero/><GalleryGrid/><GalleryCTA/><Footer/></main>}
