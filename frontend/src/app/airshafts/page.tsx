...
import AirShaftVisualGallery from "@/components/public/airshafts/AirShaftVisualGallery";
...
export default function AirShaftsPage(){
  return <main className="min-h-[100svh] overflow-x-hidden bg-[#0B1220] text-white">
    <Header/>
    <AirShaftHero/>
    <AirShaftVisualGallery/>
    <AirShaftTypes/>
    <AirShaftDiagram/>
    <Footer/>
  </main>
